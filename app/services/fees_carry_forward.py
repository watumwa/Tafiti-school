...
def build_carry_forward_preview(*, source_term, target_term, class_id="", active_students_only=True, student_id=""):
    ...
    if student_id:
        source_bills = source_bills.filter(student_id=student_id)
...
@transaction.atomic
def post_carry_forward(*, source_term, target_term, class_id="", active_students_only=True, student_id=""):
